...
2. На главной странице выберите вкладку C++ или используйте выпадающее меню "Select Language" в верхней части экрана и выберите C++.
3. 3. В открывшемся редакторе начните писать свой код. Если вы выбрали Start with an Example, удалите или замените стандартный код.  
